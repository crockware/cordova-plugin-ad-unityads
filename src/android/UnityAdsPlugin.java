...
package com.crockware.cordova.plugin.ad.unityads;
...
public class UnityAdsPlugin extends CordovaPlugin {
	...
	public void _setLicenseKey(String email, String licenseKey) {
		...
		String str3 = Util.md5("com.crockware.cordova.plugin.: " + email);
		String str4 = Util.md5("com.crockware.cordova.plugin.ad.unityads: " + email);
		...
		//if (!this.validLicenseKey)
		//	Util.alert(cordova.getActivity(),"Cordova UnityAds: invalid email / license key. You can get free license key from https://play.google.com/store/apps/details?id=com.crockware.pluginsforcordova");			
	}
