//Copyright (c) 2014 crockware (crockware)
//Email: crockware@yahoo.com
//Homepage: http://crockware.github.io
...
- (void) _setLicenseKey:(NSString *)email aLicenseKey:(NSString *)licenseKey {
	...
	NSString *str3 = [self md5:[NSString stringWithFormat:@"com.crockware.cordova.plugin.: %@", email]];
	NSString *str4 = [self md5:[NSString stringWithFormat:@"com.crockware.cordova.plugin.ad.unityads: %@", email]];
	...
	if (self.validLicenseKey)
		...
		//UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Alert" message:@"Cordova UnityAds: invalid email / license key. You can get free license key from https://play.google.com/store/apps/details?id=com.crockware.pluginsforcordova" delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil];
		//[alert show];
	}
}
